...
def register():
    ...
    if form.validate_on_submit():
        ...
        db.session.add(user)
        db.session.commit()
        flash('Account Created sucessfully!! Login Now' ,'sucess')
...
def account():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash("Account is Modified","sucess")
...
def reset_token():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('Password Reset sucessfully!! Login Now' ,'sucess')
        return redirect(url_for('login'))
